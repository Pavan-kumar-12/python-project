...
class Bill_App:
    def __init__(self, root):
        ...
        cphn_lbl = Label(F1, text="Customer Name", bg=bg_color, fg="white", font=("times new roman", 18, "bold")).grid(
            row=0, column=0, padx=20, pady=5)
        cphn_txt = Entry(F1, width=15, textvariable=self.c_name, font="arial 15", bd=7, relief=SUNKEN).grid(row=0,
                                                                                                            column=1,
                                                                                                            padx=5,
                                                                                                            pady=10)
        ...
        GBill_btn = Button(btn_F, text="Genrate Bill", command=self.bill_area, bg="cadetblue", fg="white", bd=2,
